...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-3xl border border-slate-100 bg-white/90 backdrop-blur-sm shadow-xl px-5 py-6 sm:px-7 sm:py-7">
            <div class="space-y-4">

                {{-- Email --}}
                <a
                    href="mailto:thammoud2000@gmail.com?subject=Product%20Inquiry&body=Hello,%20I%20would%20like%20to%20ask%20about%20your%20products."
                ...
                {{-- WhatsApp --}}
                <a
                    href="https://wa.me/96170123456?text=Hello%20I%20am%20interested%20in%20your%20products"
                    target="_blank"
