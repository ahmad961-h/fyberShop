        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="h-16 lg:h-18 flex items-center justify-between">
                ...
                <a href="{{ route('home') }}"
                    ...
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg blur opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                        <span class="relative bg-gradient-to-r from-indigo-600 via-purple-600 to-emerald-600 bg-clip-text text-transparent">
                ...
                <form action="{{ route('search') }}" method="GET"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-emerald-500/10 rounded-full blur opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('cart.index') }}"
                        ...
                        <svg class="w-5 h-5 text-slate-700 group-hover:text-indigo-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.2 6H19" />
                        </svg>

                        @if($cartCount > 0)
                        <span class="absolute -top-1 -right-1 bg-gradient-to-r from-rose-500 to-pink-600 text-white
                    ...
                    <div class="relative hidden md:block" style="z-index: 1000;">
                        <button id="user-menu-button"
                            class="group inline-flex items-center justify-center w-10 h-10 rounded-xl
                                       ...
                                       hover:from-indigo-50 hover:to-purple-50 hover:border-indigo-300 hover:shadow-lg transition-all duration-300 hover:scale-110
                                       user-menu-button">
                            <svg class="w-5 h-5 text-slate-700 group-hover:text-indigo-600 transition-colors" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div id="user-menu"
                            ...
                            <div class="px-4 py-3 border-b border-slate-200 bg-gradient-to-r from-indigo-50 to-purple-50">
                                <p class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">{{ __('messages.Account') }}</p>
                            ...
                            <div class="py-2">
                                <a href="{{ route('profile.edit') }}"
                                    ...
                                    <svg class="w-4 h-4 text-slate-400 group-hover:text-indigo-600 transition-all duration-200 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                    </svg>
                                    <span class="group-hover:translate-x-1 transition-transform duration-200">{{ __('messages.Profile') }}</span>
                                </a>
                                ...
                                <a href="{{ route('orders.index') }}"
                                    ...
                                    <span class="group-hover:translate-x-1 transition-transform duration-200">{{ __('messages.Manage Orders') }}</span>
                                </a>
          ...
          rounded-lg mx-2 hover:shadow-sm">
                            ...
                            <div class="px-4 py-2 bg-gradient-to-r from-amber-50 to-orange-50">
                                <p class="text-xs font-bold text-amber-700 uppercase tracking-wider mb-2">{{ __('messages.Admin') }}</p>
                                <a href="{{ route('products.create') }}"
                                    ...
                                    <span class="group-hover:translate-x-1 transition-transform duration-200">{{ __('messages.Add Product') }}</span>
                                </a>
                                ...
                                <a href="{{ route('admin.orders.index') }}"
                                    class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700
                                          ...
                                          hover:shadow-sm">
                                    <svg class="w-4 h-4 text-slate-400 group-hover:text-amber-700 transition-all duration-200 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    <span class="group-hover:translate-x-1 transition-transform duration-200">{{ __('messages.Admin Orders') }}</span>
                                </a>
                            </div>
                            @endif
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button type="submit"
                                    ...
                                    <span class="group-hover:translate-x-1 transition-transform duration-200">{{ __('messages.Logout') }}</span>
                                </button>
                            </form>
                        </div>
                    </div>
                    ...
                    {{-- Language --}}
                    <div class="hidden md:flex items-center gap-1.5 bg-slate-100 rounded-xl p-1 border border-slate-200">
                    ...
                    <button id="mobile-menu-button"
                        ...
                        <svg id="mobile-menu-icon" class="w-6 h-6 text-slate-700 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                        <svg id="mobile-menu-close" class="w-6 h-6 text-slate-700 hidden transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="space-y-3">
                    <a href="{{ route('cart.index') }}"
                        class="group flex items-center justify-center gap-2 w-full py-3.5 rounded-xl
                          ...
                          hover:from-indigo-50 hover:to-purple-50 hover:border-indigo-300 hover:shadow-lg transition-all duration-300">
                        <svg class="w-5 h-5 text-slate-700 group-hover:text-indigo-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.2 6H19" />
                        </svg>
                        <span class="font-semibold text-slate-700 group-hover:text-indigo-600 transition-colors">{{ __('messages.Cart') }}</span>
                        @if($cartCount > 0)
                        <span class="bg-gradient-to-r from-rose-500 to-pink-600 text-white text-xs font-black px-2 py-0.5 rounded-full">
                            {{ $cartCount }}
                        </span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('checkout') }}"
                        ...
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        {{ __('messages.Checkout') }}
                    </a>
                </div>
                ...
                <div class="space-y-2">
                    <a href="{{ route('orders.index') }}"
                        ...
                        <svg class="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                        </svg>
                    ...
                    <a href="{{ route('profile.edit') }}"
                        class="flex items-center justify-center gap-2 w-full py-3 rounded-xl
                              ...
                              hover:from-indigo-50 hover:to-purple-50 hover:border-indigo-300 hover:shadow-md transition-all duration-300">
                        <svg class="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                        </svg>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button type="submit"
                            ...
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                            </svg>
                            {{ __('messages.Logout') }}
                        </button>
                    </form>
