            ...
            <div class="bg-white/90 backdrop-blur-sm border border-slate-100 shadow-xl rounded-3xl p-4 sm:p-7">
                                ...
                                <tr>
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            <img src="{{ $mainImage && $mainImage->path ? asset('fyberShop/public/storage/' . $mainImage->path) : 'https://via.placeholder.com/60' }}"
                                    ...
                                    <td class="p-4 text-center">
                                        <div
                                            class="inline-flex items-center rounded-xl border-2 border-slate-200 overflow-hidden bg-white shadow-sm">
                                            ...
                                            <span
                                                class="px-4 py-2 font-bold text-slate-900 min-w-[2.5rem] text-center bg-slate-50">
                                                {{ $qty }}
                                            </span>
                ...
                <div class="md:hidden space-y-4">
                    @foreach ($cartItems as $item)
                        ...
                        <div
                            class="border-2 border-slate-200/50 rounded-3xl p-4 bg-white/90 backdrop-blur-sm shadow-lg">
                            <div class="flex gap-3">
                                <img src="{{ $mainImage && $mainImage->path ? asset('fyberShop/public/storage/' . $mainImage->path) : 'https://via.placeholder.com/60' }}"
                                    alt="{{ $item->product->name }}" class="w-16 h-16 rounded-xl object-cover border">
                ...
                <div class="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="text-right">
                        ...
                        <div class="mt-3 flex gap-2 justify-end">
                            <button type="button" wire:click="clearCart" wire:confirm="{{ __('messages.Remove') }}?"
