...
@section('content')
                ...
                @foreach ($products as $product)
                    <a href="{{ route('products.show', $product->id) }}"
                        ...
                        <div class="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                            ...
                            <img src="{{ $mainImage ? asset('fyberShop/public/storage/' . $mainImage->path) : 'https://via.placeholder.com/600x450' }}"
    ...
    transition-transform duration-500">
                            ...
                            <div
                                class="absolute bottom-4 left-4 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 text-sm font-black shadow-xl">
                ...
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-slate-100 mb-4">
                    <svg class="w-8 h-8 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M10 10l-6 6m0 0l6 6m-6-6h18"></path>
                    </svg>
                </div>
